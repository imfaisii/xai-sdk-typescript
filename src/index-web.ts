/** xAI TypeScript/JavaScript SDK (gRPC-Web), for Cloudflare Workers and other fetch-only runtimes. */

export { Client } from "./client-web.js";
export type { ClientOptions } from "./transport-web.js";
